...
- A faint horizontal scanline: `repeating-linear-gradient` with a **4px period** at roughly **1.6% white**, on the root element. The page color (not the scanline) fills the iOS safe-area insets.
