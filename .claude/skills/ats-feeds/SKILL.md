...
- Seeded tokens (sample): `stripe`, `databricks`, `coinbase`, `gusto`, `airtable`, `brex` — most of the seed is Greenhouse.
...
- Seeded sites (sample): `spotify`, `palantir`, `matchgroup`.
...
- Seeded orgs (sample): `notion`, `ramp`, `linear`, `openai`, `deel`.
